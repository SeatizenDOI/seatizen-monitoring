            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
                <div className="bg-white rounded-xl shadow-lg p-6 max-w-md w-full mx-4 text-center">
                    ...
                    <div className="flex justify-center gap-4">
                        ...
                        <button
                            onClick={handleStart}
                            className="px-4 py-2 rounded-md bg-gradient-to-r from-blue-500 to-blue-700 text-white font-semibold shadow hover:opacity-90 transition"
                        >
                            Start
                        </button>
                    </div>
        ...
        <div className="fixed inset-0 z-50 pointer-events-none">
            ...
            >
                ...
                <div className="flex flex-row justify-between">
                    <button
                        onClick={nextStep}
                        className="bg-gradient-to-r from-blue-500 to-blue-700 hover:opacity-90 text-white px-4 py-2 rounded-md font-semibold transition"
                    >
